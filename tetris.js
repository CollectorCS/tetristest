class Tetris {
    ...
    setupEventListeners() {
        ...
        document.getElementById('mobileSoftDrop').addEventListener('touchstart', (e) => {
            e.preventDefault();
            if (this.gameRunning && !this.gamePaused) {
                this.movePiece(0, 1);
            }
        ...
        document.getElementById('mobileHardDrop').addEventListener('touchstart', (e) => {
            e.preventDefault();
            if (this.gameRunning && !this.gamePaused) {
                this.hardDrop();
            }
        ...
        // Also support click events for mobile (some devices)
        ...
        document.getElementById('mobileSoftDrop').addEventListener('click', (e) => {
            e.preventDefault();
            if (this.gameRunning && !this.gamePaused) {
                this.movePiece(0, 1);
            }
    ...
    updateLevel() {
        ...
        if (scoreThreshold === 0) {
            ...
            this.dropInterval = 750; // 2000 score
        } else if (scoreThreshold === 2) {
            this.dropInterval = 550; // 4000 score - faster than 2000
        } else if (scoreThreshold === 3) {
            this.dropInterval = 350; // 6000 score - faster than 4000
        } else {
